<template>
    <div v-show="active === 'combat'" class="general_margin">
        <div class="combat_graphics_container">
            <div id="info_player_graphic" class="general_margin general_outline combat_graphic">
                Player will go here
            </div>
            <div id="info_soul_graphic" class="general_margin">
                a lil soul icon will go here <br />
                <button @click="startFight(mapStuff.enemyList.rat)">test</button>
                <button @click="runTurn()">go</button>
            </div>
            <div id="info_enemy_graphic" class="general_margin general_outline combat_graphic">
                enemy will go here
            </div>
        </div>
        <div class="stats_flex_container">
            <div class="general_margin general_outline stats_container">
            ...
            <div v-show="fighting" class="general_margin general_outline stats_container" >
                <div class="general_outline info_hp_bar_outline">
        ...
        <div id="info_combat_log" class="general_margin">
